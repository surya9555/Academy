...
<body>
  ...
  <form action="stduser.php" method="POST">
    <input type="text" class="input"  name="name" placeholder="Name*" required><br>
    <input type="text" class="input" name="mobile_no" placeholder="Mobile No*" required><br>
    <input type="text" class="input" name="gender" placeholder="Gender*" required><br>
    ...
    <input type="password" class="input" name="confrmpassword" placeholder="Confirm password" required><br>
